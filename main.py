...
tweet_df = df[['comment','Topic']]

tweet_df["Topic"].value_counts()
sentiment_label = tweet_df.Topic.factorize()

tweet = tweet_df.comment.values
...
tweet_df = df1[['comment','sentiment']]
